function SignIn() {
    return (
      <div className="flex h-screen">
        {/* Formulario */}
        <div className="flex flex-col justify-center items-center w-full lg:w-1/2 bg-white px-6 py-10">
          <div className="max-w-sm w-full">
            ...
            <form>
              <div className="mb-6 relative">
                ...
                <label
                  htmlFor="email"
                  className="absolute left-4 text-sm font-medium text-gray-700 duration-300 top-1/2 transform -translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-0 peer-focus:left-4 peer-focus:text-xs peer-focus:font-semibold peer-focus:bg-white peer-focus:px-1"
                >
                  Email
                </label>
              </div>
