        ...
        <div className="flex h-screen">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-6">
                <div className="max-w-[570px] w-full">
                    <h2 className="text-center text-[#4338CA] font-roboto text-[20px] mb-12 tracking-[0.02em]">
                        Change role to
                    </h2>
                    ...
                    <div className="space-y-7">
                        {/* Author Card */}
                        <Link to="#" className="block w-full bg-white border border-[#E5E5E5] rounded-[15px] p-5">
                            <div className="flex items-center">
                                <div className="flex -space-x-4">
                                    <img className="w-[35px] h-[35px] rounded-full" src="https://randomuser.me/api/portraits/men/1.jpg" alt="" />
                                    <img className="w-[45px] h-[45px] rounded-full" src="https://randomuser.me/api/portraits/women/2.jpg" alt="" />
                                    <img className="w-[35px] h-[35px] rounded-full" src="https://randomuser.me/api/portraits/men/3.jpg" alt="" />
                                </div>
                                <div className="ml-5">
                                    <h3 className="font-roboto font-semibold text-[20px] text-[#4338CA] tracking-[0.02em]">Join as an Author!</h3>
                                    <p className="font-roboto font-light text-[16px] text-[#4338CA] tracking-[0.02em]">I'm a reader writing a manga</p>
                                </div>
                                <div className="ml-auto w-[25px] h-[25px] border border-[#E5E5E5] rounded-full" />
                            </div>
                        </Link>

                        {/* Company Card */}
                        <Link to="#" className="block w-full bg-white border-2 border-[#4338CA] rounded-[15px] p-5">
                            <div className="flex items-center">
                                <div className="flex -space-x-4">
                                    <img className="w-[35px] h-[35px] rounded-full" src="https://randomuser.me/api/portraits/women/4.jpg" alt="" />
                                    <img className="w-[45px] h-[45px] rounded-full" src="https://randomuser.me/api/portraits/men/5.jpg" alt="" />
                                    <img className="w-[35px] h-[35px] rounded-full" src="https://randomuser.me/api/portraits/women/6.jpg" alt="" />
                                </div>
                                <div className="ml-5">
                                    <h3 className="font-roboto font-semibold text-[20px] text-[#4338CA] tracking-[0.02em]">Join as a Company!</h3>
                                    <p className="font-roboto font-light text-[16px] text-[#4338CA] tracking-[0.02em]">I'm a company and I want to publish my comics</p>
                                </div>
                                <div className="ml-auto w-[25px] h-[25px] bg-[#4338CA] rounded-full flex items-center justify-center">
            ...
            <div className="hidden md:block w-1/2 bg-cover bg-center"
                style={{
                    backgroundImage: `linear-gradient(0deg, rgba(67, 56, 202, 0.15), rgba(67, 56, 202, 0.15)),
                                   linear-gradient(0deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),
                                   url('https://s3-alpha-sig.figma.com/img/b8b4/c1ca/d91c01d1ff2a1a1341ce3c24609e0349?Expires=1734307200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=gqOlUaZrihLOcb8a3YFZ7Ab9cCdJgSozuary8Lfwzg~Qm2qbvbDU7onI-m8Wdue-ZUDzDAUmJ9BbtX6RUVGlUJLA-AZz~32HVTU7TcptrojKmmyc~IA~TEPcBiJP8gUvBfi1bctlKNkVBGklXo4n0gmdvoQwdmOARzm52LnXUUZQ0aXouvrCPWcePVswxYiZGXb36tHY0HccbIPF~SyUNto3ev7kZ1I2SZ4PtmrV2wvPGljVAdz-oGf4F-v0Stw68W2D9j2ycWUCLrwR06bmfID5lbvsWHvMYp7BULmbAqHLjBigaQdqyjOE-TRopZYkpOCjB0bYBsgHHqGxlaA1cg__')`
                }}
            >
                <div className="p-[82px] pt-[170px] max-w-[553px]">
                    <p className="font-poppins font-semibold text-[24px] leading-[36px] text-white">
                    ...
                    <div className="mt-[45px] flex items-center">
                        <div className="w-[28px] h-[1px] bg-white" />
                        <span className="ml-3 font-roboto text-[16px] tracking-[0.02em] text-white">
                            Ignacio Borraz
                        </span>
                    </div>
                </div>
