        ...
        <div className="flex h-screen">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-6">
                <div className="max-w-[570px] w-full">
                    {/* Title */}
                    <h2 className="text-center text-[#4338CA] font-roboto text-xl mb-8 tracking-[0.02em]">
                        Change role to
                    </h2>
                    ...
                    <div className="space-y-5">
                        ...
                        >
                            <div className="flex items-center">
                                <div className="flex -space-x-3">
                                    <img className="w-[35px] h-[35px] rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/men/1.jpg" alt="" />
                                    <img className="w-[35px] h-[35px] rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/women/2.jpg" alt="" />
                        ...
                        >
                            <div className="flex items-center">
                                <div className="flex -space-x-3">
                                    <img className="w-[35px] h-[35px] rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/women/4.jpg" alt="" />
                                    <img className="w-[35px] h-[35px] rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/men/5.jpg" alt="" />
