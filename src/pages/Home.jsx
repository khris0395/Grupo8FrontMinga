...
function Home() {
    ...
    return (
        <div className="h-screen bg-[#EBEBEB] overflow-hidden">
            {/* Vista Móvil */}
                ...
                <div className="relative h-full w-full">
                    ...
                    <div className="relative h-full flex flex-col">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center text-white px-4">
                            <h1 className="text-3xl font-bold font-roboto mb-4">
                                Your favorite comic book store
                            </h1>
                            <p className="text-base font-roboto mb-8">
                            ...
                            <button className="w-full h-[55px] bg-gradient-to-r from-[#4338CA] to-[#5E52F3] rounded-[6px] font-roboto font-medium text-xl">
                                Let's go!
                            </button>
                        </div>
                    </div>
