...
import '../components/Profiles/EdithAuthor.css'
...
export default function Profiles() {
    ...
    const { profile, mangas, role, loading, error } = useSelector((state) => state.profiles)
    const { _id } = useSelector((state) => state.profiles)
