...
const EditProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      {/* Content Section */}
      <div className="max-w-[1348px] mx-auto md:-mt-[176px] relative bg-white  rounded-t-2xl p-8 flex flex-col md:flex-row gap-8">
        {/* Profile Image for Small Screens */}
        <div className="md:hidden flex justify-center mb-4 mt-16">
          <img
        ...
        {/* Form Section */}
        <div className="bg-white p-[30px] w-[437px] mx-auto pt-[54px] pl-[121px]">

          <div className="w-[377px] pt-[54px] px-[25px]">

            <div className="w-full max-w-[280px] bg-white p-8">
